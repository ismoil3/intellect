    ...
    <Container>
      <div
        className={`w-full p-8 rounded-3xl shadow-2xl transition-all ${
          darkMode ? "bg-gray-900 text-white" : "bg-gradient-to-br from-purple-50 to-blue-50"
        }`}
      >
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* Ліва частина */}
          <div className="space-y-6 relative">
            <h1 className={`text-3xl sm:text-4xl md:text-5xl font-bold leading-tight ${darkMode ? "text-white" : "text-gray-900"}`}>
              Поможем решить все вопросы
            </h1>
            <p className={`text-lg ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
              Если вы хотите узнать больше о Skillbox или не знаете, какую программу обучения выбрать, оставьте заявку — и мы перезвоним
            </p>
