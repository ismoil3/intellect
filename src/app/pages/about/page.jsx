      ...
      <div className="flex flex-col items-center mt-[50px] lg:flex-row lg:justify-between">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 w-full max-w-4xl">
          <div className={`rounded-lg p-8 ${bgColor}`}>
            ...
            <div className={`text-gray-600 ${darkMode ? "text-gray-400" : ""}`}>
              Курсов
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-[28px]">
          ...
          >
            ...
            <div>
              ...
              >
                ...
                фароҳам созем. Омодаем таҷрибаву донишҳои худро ба нафароне, ки
                хоҳиши дар соҳаи IT рушд карданро доранд, диҳем.!
              </p>
              <p
              ...
              >
                «Дар SoftClub мо як гурӯҳи муаллимони ботаҷрибаро ҷамъ овардем,
                ки ба шумо дар омӯхтану фаҳмидани ҳама масъалаҳои барномасозӣ
                кумак мекунанд»
              </p>
              <p
          ...
          >
            ...
            <div>
              ...
              >
                «Мо худро ба ҳар як барномасози хоҳишманд ва ба ҳар орзуе, ки то
              ...
              >
                Мо ба қудрати технология боварӣ дорем ва кӯшиш мекунем, ки байни
                орзуҳо ва воқеият масофаи дур набошад. Ҷаҳонбинии мо аз чорчӯба
                берун аст: мо ҳаваси амалкуниро бедор мекунем, мушкилиҳои
                воқеиро ҳал карда, дарҳоро ба имкониятҳои беохир мекушоем.
              </p>
              <p
                className={`font-semibold text-[14px] italic ${
                  darkMode ? "text-white" : ""
